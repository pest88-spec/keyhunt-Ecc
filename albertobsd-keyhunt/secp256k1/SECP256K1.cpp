...
// Non-SSE implementations for MinGW compatibility
void sha256sse_1B(uint32_t *i0, uint32_t *i1, uint32_t *i2, uint32_t *i3, uint8_t *d0, uint8_t *d1, uint8_t *d2, uint8_t *d3) {
  sha256((uint8_t*)i0, 64, d0);
  sha256((uint8_t*)i1, 64, d1);
  sha256((uint8_t*)i2, 64, d2);
  sha256((uint8_t*)i3, 64, d3);
}

void sha256sse_2B(uint32_t *i0, uint32_t *i1, uint32_t *i2, uint32_t *i3, uint8_t *d0, uint8_t *d1, uint8_t *d2, uint8_t *d3) {
  sha256((uint8_t*)i0, 128, d0);
  sha256((uint8_t*)i1, 128, d1);
  sha256((uint8_t*)i2, 128, d2);
  sha256((uint8_t*)i3, 128, d3);
}

void ripemd160sse_32(uint8_t *i0, uint8_t *i1, uint8_t *i2, uint8_t *i3, uint8_t *d0, uint8_t *d1, uint8_t *d2, uint8_t *d3) {
  ripemd160_32((unsigned char*)i0, (unsigned char*)d0);
  ripemd160_32((unsigned char*)i1, (unsigned char*)d1);
  ripemd160_32((unsigned char*)i2, (unsigned char*)d2);
  ripemd160_32((unsigned char*)i3, (unsigned char*)d3);
}
